...
export default function CreateProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('[DEBUG] プロフィール作成開始:', formData);
    ...
    try {
      ...
      console.log('[SUCCESS] プロフィール作成成功');
      router.push('/home');
    } catch (err: any) {
      console.error('[ERROR] プロフィール作成エラー:', err);
    ...
    <main className="min-h-screen bg-background py-8">
      <div className="max-w-2xl mx-auto px-4">
        <div className="bg-gray-800 rounded-lg p-8 shadow-xl">
          <h1 className="text-3xl font-bold text-white mb-2">プロフィール作成</h1>
          <p className="text-gray-400 mb-6">基本情報を入力してください</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-primary hover:bg-blue-800 text-white font-semibold py-3 px-4 rounded disabled:opacity-50 disabled:cursor-not-allowed transition"
            >
              {uploadingImage
                ? '画像をアップロード中...'
                : loading
